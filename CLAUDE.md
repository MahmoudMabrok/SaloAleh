...
| `delete-inactive-users.yml` | Daily 03:00 UTC (~05:00 Cairo) + workflow_dispatch | `scripts/delete-inactive-users.js` — prunes stale users (no achievement ≥3d inactive; with achievement >7d) and current-round players (cascade + 0 score for two days) |
