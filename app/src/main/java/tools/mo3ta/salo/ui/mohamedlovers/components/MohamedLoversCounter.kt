...
internal fun MohamedLoversCounter(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.mohamed_lovers_counter_tag),
            style = TextStyle(
        ...
        if (isFridayBonus) {
            Text(
                text = stringResource(R.string.mohamed_lovers_friday_bonus_label),
                style = TextStyle(
                    fontFamily = MohamedLoversFonts.arabic,
        ...
        if (pending > 0) {
            ...
            Text(
                text = stringResource(R.string.mohamed_lovers_counter_pending, pending),
                style = TextStyle(
                    fontFamily = MohamedLoversFonts.display,
            ...
            Spacer(Modifier.height(4.dp))
            Text(
                text = stringResource(R.string.mohamed_lovers_counter_hint),
                style = TextStyle(
                    fontFamily = MohamedLoversFonts.display,
                    fontStyle = FontStyle.Italic,
                    fontSize = 12.sp,
