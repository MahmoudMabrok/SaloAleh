...
class DhikrChallengeStore(private val settings: Settings) {
     ...
     * locally-counted dhikr (taps + applied manual entries) so the overall total-over-time is
    ...
    private fun publishWeekly(today: LocalDate, total: Int): Int =
        settings.syncWeeklyGoal("dhikr", today, total)
    ...
    private companion object {
        ...
        const val KEY_LIFETIME = "dhikr_challenge_lifetime"
    }
}
