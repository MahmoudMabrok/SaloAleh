...
/**
 * Local ledger for the "الكلمات الأربع" tasbih challenge — mirrors
 ...
 */
class KalimatChallengeStore(private val settings: Settings) {
    ...
    private companion object {
        ...
        const val KEY_REMOTE = "kalimat_challenge_count"
        const val KEY_PENDING = "kalimat_challenge_pending"
        const val KEY_MANUAL = "kalimat_challenge_manual"
    }
}
