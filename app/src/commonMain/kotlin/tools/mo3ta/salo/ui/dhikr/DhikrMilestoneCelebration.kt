...
import tools.mo3ta.salo.generated.resources.dhikr_milestone_subtitle
import tools.mo3ta.salo.generated.resources.dhikr_milestone_title
        ...
        Box(
            ...
            AnimatedVisibility(
                ...
                Surface(
                    ...
                    color = Color(0xFF064B2A).copy(alpha = 0.95f),
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.dhikr_milestone_subtitle),
                        ...
                        Text(
                            text = stringResource(Res.string.dhikr_milestone_title, milestone),
                            color = Color.White,
                            fontSize = 17.sp,
