...
fun OverlayPermissionRationaleDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Column(
            ...
            Text(
                text = "الصلاة على النبي ﷺ في أي وقت",
                color = Color.White,
                fontSize = 20.sp,
            ...
            Text(
                text = "لتشغيل فقاعة الصلوات فوق التطبيقات الأخرى، نحتاج إذن \"الظهور فوق التطبيقات\".\n\nهذا الإذن يتيح لك عدّ صلواتك حتى أثناء استخدام تطبيقات أخرى.",
