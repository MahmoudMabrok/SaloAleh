...
import tools.mo3ta.salo.generated.resources.istighfar_milestone_subtitle
import tools.mo3ta.salo.generated.resources.istighfar_milestone_title
...
@Composable
fun IstighfarMilestoneCelebration(
    milestone: Int,
    visible: Boolean,
    onDismiss: () -> Unit,
        ...
        Box(
            ...
            AnimatedVisibility(
                ...
                Surface(
                    ...
                    color = Color(0xFF4A2E1B).copy(alpha = 0.95f),
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.istighfar_milestone_subtitle),
                        ...
                        Text(
                            text = stringResource(Res.string.istighfar_milestone_title, milestone),
                            color = Color.White,
                            fontSize = 17.sp,
