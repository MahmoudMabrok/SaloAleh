...
globalThis.SPEECH_COLLECTOR_CONFIG = Object.freeze({
  ...
  ui: {
    ...
    choosePhrase: "اختر العبارة التي تريد تسجيلها",
    recordedCount: "عدد التسجيلات المرفوعة من هذه العبارة: {count}",
    record: "تسجيل",
    ...
    readyForAnother: "تم الرفع. يمكنك تسجيل عينة أخرى لنفس العبارة، أو الانتقال إلى عبارة أخرى.",
    ...
    discardConfirm: "لديك تسجيل لم يُرفع بعد. الانتقال إلى عبارة أخرى سيحذفه. هل تريد المتابعة؟",
    recordingDiscarded: "تم حذف التسجيل غير المرفوع. اضغط «تسجيل» للبدء من جديد.",
    skipHint: "بعد الرفع تبقى على العبارة نفسها لتسجيل عينة أخرى. استخدم «التالي» أو «السابق» أو القائمة للتنقل بين العبارات في أي وقت.",
    completed: "شكرًا! أصبح لكل عبارة عينة واحدة على الأقل. تسجيل عينات إضافية لأي عبارة يفيدنا كثيرًا."
  },
